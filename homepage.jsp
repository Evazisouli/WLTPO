    ...
    <div class="container">
        <div class="row">
            ...
            <div class="column-66">
                ...
                <p><span style="font-size:36px">Υιοθετήστε ένα ζωάκι.</span> <br> Ένα κατοικίδιο είναι πιθανότητα μία
                    από τις καλύτερες συντροφιές, δένεται μαζί σας και κάνει κάθε στιγμή σας απολαυστική.
        ...
        <div class="rows">
            <div class="con" style="background-color: #ff5405;">
                ...
                <div class="col">
                    ...
                    <p><span style="font-size:36px">Κάνετε μία δωρεά.</span> <br> Οι φιλοζωικές οργανώσεις φιλοξενούν μεγάλο πλήθος ζώων και η προσφορά σας μπορεί 
                    να τις βοηθήσει σημαντικά να συνεχίσουν στο έργο τους.<br>
                    Μέχρι και η ελάχιστη δωρεά μπορεί να προσφέρει πολλά στους μικρούς μας φίλους.<br>
                    Κάνετε την αρχή δωρίζοντας οτιδήποτε μπορεί να είναι απαραίτητο.</p>
                    <br>
        ...
        <div class="rows2">
            <div class="cont" style="background-color: orangered">
                <div class="colum">
                    ...
                    <p><span style="font-size:36px">Μην ξεχάσετε να το δημοσιεύσετε!</span> <br> Ένας απίστευτα μεγάλος αριθμός ιδιοκτητών έχει τύχει να χάσει το κατοικίδιο του οριστικά, 
                        μη μπορώντας να το ξαναβρεί ποτέ.<br>
                        Ταυτόχρονα, τόσοι από εμάς βρίσκουμε καθημερινά κατοικίδια, τα οποία δυστυχώς παραμένουν χαμένα.<br>
                        Ας κάνουμε κάτι για αυτό λοιπόν!
